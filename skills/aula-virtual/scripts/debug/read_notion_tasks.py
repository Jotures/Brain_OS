...
def main():
    ...
    usando la herramienta MCP de Notion.
    
    ⚠️ NOTA IMPORTANTE: Si `query_data_source` falla, usa `mcp_notion-mcp-server_API-post-search`.
    Query: "Tarea" | Filter: {property: "object", value: "page"}
    """
