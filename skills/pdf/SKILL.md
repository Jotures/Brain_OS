...
| Command | Action |
| :--- | :--- |
| **"Merge these PDFs"** | Combines multiple PDF files into one. |
| **"Split this PDF"** | Breaks a PDF into individual pages or ranges. |
| **"Extract text from [file]"** | Converts PDF content to plain text (with layout preservation). |
| **"Extract tables from [file]"** | identifying and exporting tabular data to Excel/CSV. |
| **"Create PDF from [text]"** | Generates a new PDF document from provided content. |
| **"OCR this scanned PDF"** | Extracts text from image-based PDFs using Tesseract. |
| **"Protect [file] with password"** | Encrypts a PDF file. |
